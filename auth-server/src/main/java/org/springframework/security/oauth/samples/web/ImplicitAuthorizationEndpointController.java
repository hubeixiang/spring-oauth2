...
/**
 * 隐式授权的返回页面增加refresh_token,不做其他修改
 */
@Controller
public class ImplicitAuthorizationEndpointController extends AbstractEndpoint {
    ...
    public void init() {
        ...
        this.setProviderExceptionHandler(getEndpointsConfigurer().getExceptionTranslator());
        this.setErrorPage(extractPath(mapping, "/oauth/error"));
        this.setTokenGranter(getEndpointsConfigurer().getTokenGranter());
        this.setClientDetailsService(clientDetailsService);
        this.setAuthorizationCodeServices(getEndpointsConfigurer().getAuthorizationCodeServices());
        this.setOAuth2RequestFactory(getEndpointsConfigurer().getOAuth2RequestFactory());
        this.setOAuth2RequestValidator(getEndpointsConfigurer().getOAuth2RequestValidator());
        this.setUserApprovalHandler(getEndpointsConfigurer().getUserApprovalHandler());
        this.setRedirectResolver(getEndpointsConfigurer().getRedirectResolver());
    }

    @RequestMapping(value = "/implicit/oauth/authorize")
    public ModelAndView authorize(Map<String, Object> model, @RequestParam Map<String, String> parameters,
        ...
        try {
            ...
            model.put("implicitAuthorizationEndpoint", authorizationRequest);
    ...
    @RequestMapping(value = "/implicit/oauth/authorize", method = RequestMethod.POST, params = OAuth2Utils.USER_OAUTH_APPROVAL)
    public View approveOrDeny(@RequestParam Map<String, String> approvalParameters, Map<String, ?> model,
        ...
        AuthorizationRequest authorizationRequest = (AuthorizationRequest) model.get("implicitAuthorizationEndpoint");
