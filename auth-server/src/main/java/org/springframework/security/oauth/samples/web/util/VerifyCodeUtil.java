...
public class VerifyCodeUtil {
    public static final String WEB_HTML_ID_KEY = "verifyCode";
    public static final String CACHE_KEY_PREFIX = "verify_code_";
    ...
    public VerifyCodeInfo createVerifyCodeInfo(int timeout) {
        ...
        verifyCodeInfo.setBufferedImage(image);
        verifyCodeInfo.setVerifyCode(text);
